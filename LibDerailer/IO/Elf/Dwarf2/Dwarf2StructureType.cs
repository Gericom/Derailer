...
{
    public class Dwarf2StructureType : Dwarf2Die
    {
        ...
        public Dwarf2StructureType(Dictionary<Dwarf2Attribute, object> attributes)
            : base(Dwarf2Tag.StructureType, attributes)
        {
        }
